    ...
    private void ggeatdataforgrid() {
        ...
        try {
            ...
            if (con == null) {
                ...
                ADA = new SimpleAdapter(CustomerLedgerReportActivity.this,
                        data, R.layout.customer_leger_gridview, from, views);
...
//  start  calender button task **********************************************
        ...
        dialog = new Dialog(CustomerLedgerReportActivity.this);
    ...
    public void customdatemethod(View view) {
        ...
        fromlineardate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                datePickerDialog = new DatePickerDialog(CustomerLedgerReportActivity.this,
